...
public class GameInitializer {
    ...
    public static Player initialPlayer(final String id, final int width, final int height, final double initialMass) {
        return new Player(id, random.nextInt(width), random.nextInt(height), initialMass);
    }

    public static Player initialPlayer(final String id, final int width, final int height) {
        return initialPlayer(id, width, height, Player.DEFAULT_MASS);
    }
